...
<body class="bg-dark text-light">
    ...
    <form action="<?php echo PROCESS_URL . '/backgroundProcess.php' ?>" method="post">
        <?php flash(); ?>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
                ...
                <div class="fadeIn first">
                    <img src="<?php echo  UPLOAD_URL . '/logo.jpg' ?>" id="icon" alt="School Logo" />
                </div>
                ...
                <!-- Remind Passowrd -->
                <div id="formFooter" class="text-dark">
